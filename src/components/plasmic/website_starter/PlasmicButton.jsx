...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IB_HD0FV8u-Y/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: gWCsHg7CcOn9/icon
import Icon25Icon from "./icons/PlasmicIcon__Icon25"; // plasmic-import: BjhDPv0KZzdr/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xLmph)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon25Icon
                className={classNames(projectcss.all, sty.svg__ewSr1)}
                role={"img"}
              />
            ),
